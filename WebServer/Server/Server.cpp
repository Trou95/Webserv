...
string Server::runCGI(const Location& location, const stRequest &request)
{
    ...
    int fd2[2];
    int pid;
    char *abc = "------WebKitFormBoundarymvX7Cyu3ArcxW341\n"
                "Content-Disposition: form-data; name=\"name\"; filename=\".yarnrc\"\n"
                ...
                "\n"
                "\n"
                "lastUpdateCheck 1670670597945\n"
                "\n"
                "------WebKitFormBoundarymvX7Cyu3ArcxW341\n";

    if(pipe(fd) == -1)
        return "";
    pipe(fd2);
    write(fd2[1], abc, strlen(abc));
